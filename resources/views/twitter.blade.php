...
<body class="h-full font-sans antialiased dark:bg-black-100">
    ...
    <main class="container mx-auto grid h-full grid-cols-4">
        ...
        <div class="relative col-span-2">
            <div class="sticky top-0 w-full bg-black-100">
                ...
                <div class="w-fill h-28 rounded-[25px] bg-black-200">
                    <x-avatar class="rounded-[39px] border-4 border-black-100/20 bg-black-200" :classes="'h-16 w-16 object-cover object-center'"
            ...
            <div class="relative h-full">
                <div class="sticky top-4 h-auto">
                    <label class="relative inline-flex cursor-pointer items-center">
                        <input type="checkbox" :value="darkMode" class="peer sr-only"
